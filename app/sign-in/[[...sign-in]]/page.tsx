...
export default function SignInPage() {
  return (
    <div className='relative pt-14 sm:pt-32 min-h-[calc(100svh-84px)]'>
      <SquaresPattern />
      <div className='flex flex-col items-center'>
        <SignIn.Root>
          <SignIn.Step name="start" className='flex flex-col items-center gap-4 px-4'>
            ...
            <p className='text-muted-foreground mt-8 text-center'>By continue with google, you agree to our Terms of Service and Privacy Policy.</p>
          </SignIn.Step>
        </SignIn.Root>
      </div>
    </div>
